...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, MAIN_COIL_EN_Pin|PRECHARGE_EN_Pin|LED_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CAN_S_GPIO_Port, CAN_S_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : NOT_ESTOP_OPEN_Pin */
  GPIO_InitStruct.Pin = NOT_ESTOP_OPEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(NOT_ESTOP_OPEN_GPIO_Port, &GPIO_InitStruct);
