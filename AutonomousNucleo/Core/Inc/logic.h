...
#define SPI_TIMEOUT_MS      (50)  // If no message in this time, set speed to 0
#define ESTOP_PULSE_WIDTH   (1800) // Pulse width above this = contactor is energized
#define ESTOP_TIMEOUT_MS    (100)  // If no valid pulse in this time, open contactor
